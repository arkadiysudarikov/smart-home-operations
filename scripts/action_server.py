...
class Handler(BaseHTTPRequestHandler):
    ...
    def route(self, allow_actions: bool | None = None) -> tuple[int, dict[str, Any]]:
        ...
        if path == "/action/announce-help":
            ...
            return (200 if payload["ok"] else 500), payload
        if path in {"/action/dr-house-" + mode for mode in ("status", "energy", "complications", "discharge", "night", "changes", "explain", "hold", "leave", "unusual", "departure", "quiet", "morning", "running", "openings", "resume", "washerfree", "more")}:
